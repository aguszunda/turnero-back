        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MarginMinutes = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_weekly_schedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_weekly_schedules_professionals_ProfessionalId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppliedPrice = table.Column<decimal>(type: "numeric(10,2)", precision: 10, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_professional_services", x => new { x.ProfessionalId, x.ServiceId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_appointments_ProfessionalId_StartsAt",
                table: "appointments",
                columns: new[] { "ProfessionalId", "StartsAt" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_professionals_IsActive_LastName",
                table: "professionals",
                columns: new[] { "IsActive", "LastName" });

            migrationBuilder.CreateIndex(
                name: "IX_services_IsActive_Name",
                table: "services",
                columns: new[] { "IsActive", "Name" });

            migrationBuilder.CreateIndex(
                name: "IX_weekly_schedules_ProfessionalId_DayOfWeek",
